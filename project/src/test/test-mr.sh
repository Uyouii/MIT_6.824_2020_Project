...
(cd ../../apps/mrsequential && go build $RACE mrsequential.go) || exit 1
...
../../apps/mrsequential/mrsequential ../../mrapps/wc/wc.so ../data/pg*txt || exit 1
...
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/wc/wc.so &
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/wc/wc.so &
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/wc/wc.so &
...
# generate the correct output
../../apps/mrsequential/mrsequential  ../../mrapps/indexer/indexer.so ../data/pg*txt || exit 1
...
# start multiple workers
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/indexer/indexer.so &
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/indexer/indexer.so
...
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/mtiming/mtiming.so &
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/mtiming/mtiming.so
...
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/rtiming/rtiming.so &
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/rtiming/rtiming.so
...
# generate the correct output
../../apps/mrsequential/mrsequential  ../../mrapps/nocrash/nocrash.so ../data/pg*txt || exit 1
...
rm -f mr-done
(timeout -k 2s 180s ../../apps/mrmaster/mrmaster ../data/pg*txt ; touch mr-done ) &
sleep 1

# start multiple workers
timeout -k 2s 180s ../../apps/mrworker/mrworker ../../mrapps/crash/crash.so &
